...
class CollateralizedSimpleInterestTermsContractRunner {
    constructor(web3) {
    ...
    setupDebtOrder(scenario) {
        return __awaiter(this, void 0, void 0, function* () {
            const { collateralizedSimpleInterestTermsContract, kernel, repaymentRouter, debtTokenContract, dummyREPToken, dummyTokenRegistryContract, } = this.contracts;
            ...
            const collateralTokenIndex = yield dummyTokenRegistryContract.getTokenIndexBySymbol.callAsync("ZRX");
...
exports.CollateralizedSimpleInterestTermsContractRunner = CollateralizedSimpleInterestTermsContractRunner;
