 ...
 */
function submitMultiSigTransaction(multiSig, contract, methodName, args, txData) {
...
function submitAndConfirmMultiSigTransaction(multiSig, contract, methodName, accounts, args = [], txData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const transactionId = yield submitMultiSigTransaction(multiSig, contract, methodName, args, transactionData);
...
function multiSigExecuteAfterTimelock(web3, multiSig, contract, methodName, accounts, args = [], timelock = migration_constants_1.TIMELOCK_IN_SECONDS, txData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const transactionId = yield submitAndConfirmMultiSigTransaction(multiSig, contract, methodName, accounts, args, txData);
        yield web3Utils.increaseTime(timelock);
        const txHash = yield multiSig.executeTransaction.sendTransactionAsync(transactionId);
