    ...
    testScenario(scenario) {
        ...
        describe(scenario.description, () => {
            before(() => __awaiter(this, void 0, void 0, function* () {
                ...
                yield mockTermsContract.mockTermEndTimestamp.sendTransactionAsync(scenario.agreementId, new bignumber_js_1.BigNumber(scenario.termEndTimestamp(latestBlockTime)));
            ...
            if (scenario.succeeds) {
                it("should not throw", () => __awaiter(this, void 0, void 0, function* () {
                    txHash = yield collateralizer.returnCollateral.sendTransactionAsync(scenario.agreementId, { from: scenario.from(COLLATERALIZER, NON_COLLATERALIZER) });
                ...
                it("should emit log that collateral has been returned", () => __awaiter(this, void 0, void 0, function* () {
                    const receipt = yield web3.eth.getTransactionReceipt(txHash);
                    const [CollateralReturnedLog] = lodash_1.compact(ABIDecoder.decodeLogs(receipt.logs));
                    chai_1.expect(CollateralReturnedLog).to.deep.equal(collateralized_contract_1.CollateralReturned(collateralizer.address, scenario.agreementId, COLLATERALIZER, mockCollateralToken.address, scenario.collateralAmount));
                }));
                it("should transfer collateral from collateralizer contract to owner", () => __awaiter(this, void 0, void 0, function* () {
                    yield chai_1.expect(mockCollateralToken.wasTransferCalledWith.callAsync(COLLATERALIZER, scenario.collateralAmount)).to.eventually.be.true;
                }));
            }
            else {
                it("should throw", () => __awaiter(this, void 0, void 0, function* () {
                    yield chai_1.expect(collateralizer.returnCollateral.sendTransactionAsync(scenario.agreementId, {
...
exports.ReturnCollateralRunner = ReturnCollateralRunner;
//# sourceMappingURL=return_collateral.js.map