...
contract("Permissions", (ACCOUNTS) => {
    ...
    describe("Library -- Client", () => __awaiter(this, void 0, void 0, function* () {
        ...
        describe("events", () => {
            ...
            it("should emit an event when an agent is authorized", () => __awaiter(this, void 0, void 0, function* () {
                const txHash = yield dummyContractInstance.authorizeInFirstSet.sendTransactionAsync(AGENT_1);
                const expectedLogEntry = permissions_lib_1.Authorized(dummyContractInstance.address, AGENT_1, "dummy-contract-first-set");
            ...
            it("should emit an event when an agent's authorization is revoked", () => __awaiter(this, void 0, void 0, function* () {
                const txHash = yield dummyContractInstance.revokeInFirstSet.sendTransactionAsync(AGENT_1);
                const expectedLogEntry = permissions_lib_1.AuthorizationRevoked(dummyContractInstance.address, AGENT_1, "dummy-contract-first-set");
        ...
        it("should start with empty permission sets", () => __awaiter(this, void 0, void 0, function* () {
            yield expect(dummyContractInstance.getFirstSetAuthorizedAgents.callAsync()).to.eventually.deep.equal([]);
        }));
        describe("authorizations", () => {
            it("starts with all agents unauthorized", () => __awaiter(this, void 0, void 0, function* () {
                const firstSetPromises = AGENTS.map((agent) => {
                    return expect(dummyContractInstance.isAuthorizedInFirstSet.callAsync(agent)).to.eventually.equal(false);
                });
                const secondSetPromises = AGENTS.map((agent) => {
                    return expect(dummyContractInstance.isAuthorizedInSecondSet.callAsync(agent)).to.eventually.equal(false);
                });
            ...
            describe("user authorizes first agent in first set", () => {
                ...
                it("authorizes first agent in first set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.isAuthorizedInFirstSet.callAsync(AGENTS[0])).to.eventually.equal(true);
                }));
                it("doesn't authorize first agent in second set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.isAuthorizedInSecondSet.callAsync(AGENTS[0])).to.eventually.equal(false);
                }));
                it("returns correct authorized agents for first set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.getFirstSetAuthorizedAgents.callAsync()).to.eventually.deep.equal([AGENTS[0]]);
                }));
            });
            describe("user authorizes second agent in first set", () => {
                ...
                it("authorizes second agent in first set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.isAuthorizedInFirstSet.callAsync(AGENTS[1])).to.eventually.equal(true);
                }));
                ...
                it("doesn't authorize second agent in second set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.isAuthorizedInSecondSet.callAsync(AGENTS[1])).to.eventually.equal(false);
                }));
                it("returns correct authorized agents for first set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.getFirstSetAuthorizedAgents.callAsync()).to.eventually.deep.equal([AGENTS[0], AGENTS[1]]);
                }));
            });
            describe("user authorizes third agent in first set", () => {
                ...
                it("authorizes third agent in first set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.isAuthorizedInFirstSet.callAsync(AGENTS[2])).to.eventually.equal(true);
                }));
                it("doesn't authorize third agent in second set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.isAuthorizedInSecondSet.callAsync(AGENTS[2])).to.eventually.equal(false);
                }));
                it("returns correct authorized agents for second set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.getFirstSetAuthorizedAgents.callAsync()).to.eventually.deep.equal([AGENTS[0], AGENTS[1], AGENTS[2]]);
                }));
            });
            describe("user authorizes third agent in second set", () => {
                ...
                it("authorizes third agent in second set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.isAuthorizedInSecondSet.callAsync(AGENTS[2])).to.eventually.equal(true);
                }));
                it("maintains third agent authorization in first set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.isAuthorizedInFirstSet.callAsync(AGENTS[2])).to.eventually.equal(true);
                }));
                it("returns correct authorized agents for second set", () => __awaiter(this, void 0, void 0, function* () {
                    expect(dummyContractInstance.getSecondSetAuthorizedAgents.callAsync()).to.eventually.deep.equal([AGENTS[2]]);
                }));
            });
        });
        describe("revocations", () => {
            describe("user revokes second agent in first set", () => {
                ...
                it("revokes second agent in first set", () => {
                    expect(dummyContractInstance.isAuthorizedInFirstSet.callAsync(AGENTS[1])).to.eventually.equal(false);
                });
                it("returns correct authorized agents for first set", () => {
                    expect(dummyContractInstance.getFirstSetAuthorizedAgents.callAsync()).to.eventually.deep.equal([AGENTS[0], AGENTS[2]]);
                });
            });
            describe("user revokes third agent in first set", () => {
                ...
                it("revokes third agent in first set", () => {
                    expect(dummyContractInstance.isAuthorizedInFirstSet.callAsync(AGENTS[2])).to.eventually.equal(false);
                });
            ...
            describe("user revokes third agent in second set", () => {
                ...
                it("returns correct authorized agents for first set", () => {
                    expect(dummyContractInstance.getSecondSetAuthorizedAgents.callAsync()).to.eventually.deep.equal([]);
                });
            });
        });
    }));
