...
contract("Debt Registry (Unit Tests)", (ACCOUNTS) => __awaiter(this, void 0, void 0, function* () {
    ...
    before(() => __awaiter(this, void 0, void 0, function* () {
        ...
        generateEntryFn = (beneficiary = BENEFICIARY_1) => {
    ...
    describe("before owner authorizes agents for editing registry", () => {
        it("should throw if any user tries to insert entry", () => __awaiter(this, void 0, void 0, function* () {
            yield expect(insertEntryFn(generateEntryFn())).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
        }));
        it("should throw if any user tries to edit entry", () => __awaiter(this, void 0, void 0, function* () {
            yield expect(modifyEntryBeneficiaryFn(generateEntryFn(), AGENT_1)).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
        }));
    });
    describe("owner authorizes agent(s) for inserting entries", () => {
        const expectedDebtorsDebts = [];
        describe("first agent", () => {
            let txHash;
            before(() => __awaiter(this, void 0, void 0, function* () {
                txHash = yield registry.addAuthorizedInsertAgent.sendTransactionAsync(AGENT_1);
            }));
            it("should emit log broadcasting authorization to insert", () => __awaiter(this, void 0, void 0, function* () {
                const expectedLogEntry = permissions_lib_1.Authorized(registry.address, AGENT_1, "debt-registry-insert");
            ...
            it("should return first agent as authorized", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(registry.getAuthorizedInsertAgents.callAsync()).to.eventually.deep.equal([AGENT_1]);
            }));
        });
        describe("second agent", () => {
            let txHash;
            before(() => __awaiter(this, void 0, void 0, function* () {
                txHash = yield registry.addAuthorizedInsertAgent.sendTransactionAsync(AGENT_2);
            }));
            it("should emit log broadcasting authorization to insert", () => __awaiter(this, void 0, void 0, function* () {
                const expectedLogEntry = permissions_lib_1.Authorized(registry.address, AGENT_2, "debt-registry-insert");
                const queryResult = yield log_utils_1.queryLogsForEvent(txHash, permissions_lib_1.EventNames.Authorized);
                expect(queryResult).to.deep.equal(expectedLogEntry);
            }));
            it("should return both first and second agents authorized", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(registry.getAuthorizedInsertAgents.callAsync()).to.eventually.deep.equal([AGENT_1, AGENT_2]);
            }));
        });
        ...
        describe("first agent inserts new entry into registry", () => {
            ...
            it("should add entry's issuance hash to first agent's list of debts", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(registry.getDebtorsDebts.callAsync(entry.getDebtor())).to.eventually.deep.equal(expectedDebtorsDebts);
            }));
            it("should throw when first agent tries editing entry", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(modifyEntryBeneficiaryFn(entry, AGENT_1, { from: AGENT_1 })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
            }));
        });
        describe("second agent inserts new entry into registry", () => {
            ...
            it("should add entry's issuance hash to debtor's list of debts", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(registry.getDebtorsDebts.callAsync(entry.getDebtor())).to.eventually.deep.equal(expectedDebtorsDebts);
            }));
            it("should throw when second agent tries editing entry", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(modifyEntryBeneficiaryFn(entry, AGENT_2, { from: AGENT_2 })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
            }));
        });
        describe("owner authorizes agent(s) for editing entries", () => {
            describe("third agent", () => {
                let txHash;
                before(() => __awaiter(this, void 0, void 0, function* () {
                    txHash = yield registry.addAuthorizedEditAgent.sendTransactionAsync(AGENT_3);
                }));
                it("should emit log broadcasting authorization to edit", () => __awaiter(this, void 0, void 0, function* () {
                    const expectedLogEntry = permissions_lib_1.Authorized(registry.address, AGENT_3, "debt-registry-edit");
                    const queryResult = yield log_utils_1.queryLogsForEvent(txHash, permissions_lib_1.EventNames.Authorized);
                    expect(queryResult).to.deep.equal(expectedLogEntry);
                }));
                it("should return first agent as authorized", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(registry.getAuthorizedEditAgents.callAsync()).to.eventually.deep.equal([AGENT_3]);
                }));
            });
            describe("fourth agent", () => {
                let txHash;
                before(() => __awaiter(this, void 0, void 0, function* () {
                    txHash = yield registry.addAuthorizedEditAgent.sendTransactionAsync(AGENT_4);
                }));
                it("should emit log broadcasting authorization to edit", () => __awaiter(this, void 0, void 0, function* () {
                    const expectedLogEntry = permissions_lib_1.Authorized(registry.address, AGENT_4, "debt-registry-edit");
                    const queryResult = yield log_utils_1.queryLogsForEvent(txHash, permissions_lib_1.EventNames.Authorized);
                    expect(queryResult).to.deep.equal(expectedLogEntry);
                }));
                it("should return third and fourth agent as authorized", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(registry.getAuthorizedEditAgents.callAsync()).to.eventually.deep.equal([AGENT_3, AGENT_4]);
                }));
            });
            ...
            describe("third agent edits existing entry in registry", () => {
                ...
                before(() => __awaiter(this, void 0, void 0, function* () {
                    entry = generateEntryFn();
                    yield insertEntryFn(entry, { from: AGENT_1 });
                    const txHash = yield modifyEntryBeneficiaryFn(entry, BENEFICIARY_2, {
                        from: AGENT_3,
                    });
                    res = yield web3.eth.getTransactionReceipt(txHash);
                }));
            ...
            describe("the beneficiary specified is null", () => {
                it("should throw when the second agent attempts to inserts a new entry", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(insertEntryFn(generateEntryFn(NULL_ADDRESS), { from: AGENT_2 })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
                it("should throw when the first agent attempts to insert a new entry", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(insertEntryFn(generateEntryFn(NULL_ADDRESS), { from: AGENT_1 })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
                it("should throw when third agent tries to modify an entry", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(modifyEntryBeneficiaryFn(generateEntryFn(NULL_ADDRESS), AGENT_3)).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
                it("should throw when fourth agent tries to modify an entry", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(modifyEntryBeneficiaryFn(generateEntryFn(NULL_ADDRESS), AGENT_4)).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
            });
        });
        describe("owner revokes second agent from inserting entries", () => {
            let txHash;
            before(() => __awaiter(this, void 0, void 0, function* () {
                txHash = yield registry.revokeInsertAgentAuthorization.sendTransactionAsync(AGENT_2, {
                    from: CONTRACT_OWNER,
                });
            }));
            it("should emit log broadcasting revocation of insert permissions", () => __awaiter(this, void 0, void 0, function* () {
                const expectedLogEntry = permissions_lib_1.AuthorizationRevoked(registry.address, AGENT_2, "debt-registry-insert");
        ...
        describe("owner revokes third agent from editing entries", () => {
            let txHash;
            before(() => __awaiter(this, void 0, void 0, function* () {
                txHash = yield registry.revokeEditAgentAuthorization.sendTransactionAsync(AGENT_3, {
                    from: CONTRACT_OWNER,
                });
            }));
            it("should emit log broadcasting revocation of insert permissions", () => __awaiter(this, void 0, void 0, function* () {
                const expectedLogEntry = permissions_lib_1.AuthorizationRevoked(registry.address, AGENT_3, "debt-registry-edit");
                const queryResult = yield log_utils_1.queryLogsForEvent(txHash, permissions_lib_1.EventNames.AuthorizationRevoked);
                expect(queryResult).to.deep.equal(expectedLogEntry);
            }));
            it("should return third agent as unauthorized", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(registry.getAuthorizedEditAgents.callAsync()).to.eventually.deep.equal([AGENT_4]);
            }));
        ...
        describe("Global Invariants", () => {
            ...
            describe("Queries tied to non-existent debt agreements", () => {
                it("should throw when querying for TermsContractParameters", () => __awaiter(this, void 0, void 0, function* () {
                    const NON_EXISTENT_AGREEMENT_ID = web3.sha3("this agreement id does not exist");
                    yield expect(registry.getTermsContractParameters.callAsync(NON_EXISTENT_AGREEMENT_ID)).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
            });
            ...
            describe("No inserts when debt registry is paused", () => {
                ...
                it("should throw", () => __awaiter(this, void 0, void 0, function* () {
                    const entry = generateEntryFn();
                    yield expect(insertEntryFn(entry)).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
            });
            ...
            describe("Only owner can authorize and revoke agents", () => {
                it("should throw if non-owner authorizes agent", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(registry.addAuthorizedInsertAgent.sendTransactionAsync(ATTACKER, {
                        from: ATTACKER,
                    })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                    yield expect(registry.addAuthorizedEditAgent.sendTransactionAsync(ATTACKER, {
                        from: ATTACKER,
                    })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
                it("should throw if non-owner revokes agent", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(registry.revokeInsertAgentAuthorization.sendTransactionAsync(ATTACKER, {
                        from: ATTACKER,
                    })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                    yield expect(registry.revokeEditAgentAuthorization.sendTransactionAsync(ATTACKER, {
                        from: ATTACKER,
                    })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
            });
            describe("Only owner can transfer ownership", () => {
                it("should throw if non-owner transfers ownership", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(registry.transferOwnership.sendTransactionAsync(ATTACKER, {
                        from: ATTACKER,
                    })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
                it("should let owner transfer ownership", () => __awaiter(this, void 0, void 0, function* () {
                    yield registry.transferOwnership.sendTransactionAsync(NEW_CONTRACT_OWNER, {
                        from: CONTRACT_OWNER,
                    });
                    yield expect(registry.owner.callAsync()).to.eventually.equal(NEW_CONTRACT_OWNER);
                }));
            });
        });
    });
