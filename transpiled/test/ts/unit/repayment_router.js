        ...
        describe("called for issued debt agreement", () => {
            ...
            describe("...with terms contract that rejects repayment", () => {
                ...
                it("should return REPAYMENT_REJECTED_BY_TERMS_CONTRACT error", () => {
                    expect(errorLog).to.deep.equal(repayment_router_2.LogError(router.address, 2 /* REPAYMENT_REJECTED_BY_TERMS_CONTRACT */, ARBITRARY_AGREEMENT_ID));
                });
                it("should not transfer tokens from payer", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(mockTokenTransferProxy.wasTransferFromCalledWith.callAsync(mockToken.address, PAYER, BENEFICIARY, Units.ether(1))).to.eventually.be.false;
                }));
        ...
        describe("Global Invariants", () => {
            describe("called with null token address", () => {
                it("should throw", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(router.repay.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, Units.ether(1), NULL_ADDRESS, { from: PAYER })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
            });
            describe("called with zero token amount", () => {
                it("should throw", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(router.repay.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, new bignumber_js_1.BigNumber(0), mockToken.address, { from: PAYER })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
                }));
            });
        });
    });
