...
contract("Debt Kernel (Unit Tests)", (ACCOUNTS) => __awaiter(this, void 0, void 0, function* () {
    ...
    const reset = () => __awaiter(this, void 0, void 0, function* () {
        ...
        const mockTermsContractInstance = yield mockTermsContractArtifacts.new();
        ...
        kernel = new debt_kernel_2.DebtKernelContract(kernelWeb3ContractInstance, TX_DEFAULTS);
        mockTermsContract = new mock_terms_contract_1.MockTermsContractContract(mockTermsContractWeb3ContractInstance, TX_DEFAULTS);
    ...
    describe("Initialization & Upgrades", () => __awaiter(this, void 0, void 0, function* () {
        describe("non-owner sets debt token contract pointer", () => {
            it("should throw", () => __awaiter(this, void 0, void 0, function* () {
                expect(kernel.setDebtToken.sendTransactionAsync(ATTACKER, { from: ATTACKER })).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
            }));
        });
        describe("owner updates debt token contract pointer", () => {
            before(() => __awaiter(this, void 0, void 0, function* () {
                yield kernel.setDebtToken.sendTransactionAsync(mockDebtToken.address, {
                    from: CONTRACT_OWNER,
                });
            }));
            it("should point to new debt token contract", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(kernel.debtToken.callAsync()).to.eventually.equal(mockDebtToken.address);
            }));
        });
    }));
        ...
        const testOrderFill = (filler, setupDebtOrder) => {
            return () => {
                ...
                before(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield mockTermsContract.reset.sendTransactionAsync();
                    yield mockTermsContract.mockRegisterTermStartReturnValue.sendTransactionAsync(debtOrder.getIssuanceCommitment().getHash(), debtOrder.getDebtor(), true);
                ...
                it("should transfer principal minus debtorFee to debtor", () => __awaiter(this, void 0, void 0, function* () {
                    if (debtOrder.getPrincipalAmount().greaterThan(0)) {
                        yield expect(mockTokenTransferProxy.wasTransferFromCalledWith.callAsync(mockPrincipalToken.address, debtOrder.getCreditor(), debtOrder.getDebtor(), debtOrder.getPrincipalAmount().minus(debtOrder.getDebtorFee()))).to.eventually.be.true;
                    }
                }));
                ...
                it("should register term start with terms contract", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(mockTermsContract.wasRegisterTermStartCalledWith.callAsync(debtOrder.getIssuanceCommitment().getHash(), debtOrder.getDebtor())).to.eventually.be.true;
                }));
            };
        };
        ...
        describe("User fills invalid debt order", () => {
            ...
            describe("...when creditorFee + principal > 0, but transfer proxy has insufficient allowance", () => {
                before(() => __awaiter(this, void 0, void 0, function* () {
                    yield resetMocks();
                    yield mockPrincipalToken.mockBalanceOfFor.sendTransactionAsync(debtOrder.getCreditor(), debtOrder.getPrincipalAmount().plus(debtOrder.getCreditorFee()));
                    yield mockPrincipalToken.mockAllowanceFor.sendTransactionAsync(debtOrder.getCreditor(), mockTokenTransferProxy.address, debtOrder
                        .getPrincipalAmount()
            ...
            describe("...when creditorFee + principal > 0, but creditor does not have sufficient balance", () => {
                before(() => __awaiter(this, void 0, void 0, function* () {
                    yield resetMocks();
                    yield mockPrincipalToken.mockBalanceOfFor.sendTransactionAsync(debtOrder.getCreditor(), debtOrder
                        .getPrincipalAmount()
                        .plus(debtOrder.getCreditorFee())
                        .minus(1));
                    yield mockPrincipalToken.mockAllowanceFor.sendTransactionAsync(debtOrder.getCreditor(), mockTokenTransferProxy.address, debtOrder.getPrincipalAmount().plus(debtOrder.getCreditorFee()));
            ...
            describe("...when terms contract returns false for `registerTermStart`", () => {
                before(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield mockPrincipalToken.mockBalanceOfFor.sendTransactionAsync(debtOrder.getCreditor(), debtOrder.getPrincipalAmount().plus(debtOrder.getCreditorFee()));
                    yield mockPrincipalToken.mockAllowanceFor.sendTransactionAsync(debtOrder.getCreditor(), mockTokenTransferProxy.address, debtOrder.getPrincipalAmount().plus(debtOrder.getCreditorFee()));
                    yield mockTermsContract.mockRegisterTermStartReturnValue.sendTransactionAsync(debtOrder.getIssuanceCommitment().getHash(), debtOrder.getDebtor(), false);
                }));
                it("should throw", () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe("#cancelIssuance", () => {
        ...
        describe("debtor cancels issuance", () => {
            ...
            it("should return issuance as cancelled", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(kernel.issuanceCancelled.callAsync(order.getIssuanceCommitment().getHash())).to.eventually.be.true;
            }));
        });
    ...
    describe("#cancelDebtOrder", () => {
        ...
        describe("debtor cancels debtor", () => {
            ...
            it("should return debt order as cancelled", () => __awaiter(this, void 0, void 0, function* () {
                yield expect(kernel.debtOrderCancelled.callAsync(order.getDebtOrderHash())).to
                    .eventually.be.true;
            }));
        });
    });
