...
const termsParamsWithCollateral = "0x08000000000de0b6b3a76400000061a8200040000000000011c37937e0800014";
contract("CollateralizedSimpleInterestTermsContract (Unit Tests)", (ACCOUNTS) => __awaiter(this, void 0, void 0, function* () {
    let termsContract;
    let collateralizer;
    let router;
    let mockToken;
    ...
    before(() => __awaiter(this, void 0, void 0, function* () {
        ...
        mockCollateralToken = yield mock_e_r_c20_token_1.MockERC20TokenContract.deployed(web3, TX_DEFAULTS);
        const repaymentRouterTruffle = yield repaymentRouterContract.new(mockDebtRegistry.address, mockTokenTransferProxy.address);
        const collateralizerContractTruffle = yield collateralizerContract.new(MOCK_DEBT_KERNEL_ADDRESS, mockDebtRegistry.address, mockTokenRegistry.address, mockTokenTransferProxy.address, { from: CONTRACT_OWNER });
        const collateralizerWeb3Contract = web3.eth
            .contract(collateralizerContract.abi)
            .at(collateralizerContractTruffle.address);
        collateralizer = new collateralizer_1.CollateralizerContract(collateralizerWeb3Contract, TX_DEFAULTS);
        const contractRegistryTruffle = yield contractRegistryArtifact.new(collateralizer.address, MOCK_DEBT_KERNEL_ADDRESS, mockDebtRegistry.address, MOCK_DEBT_TOKEN_ADDRESS, repaymentRouterTruffle.address, mockTokenRegistry.address, mockTokenTransferProxy.address, { from: CONTRACT_OWNER });
        const termsContractTruffle = yield collateralizedSimpleInterestTermsContract.new(contractRegistryTruffle.address);
        ...
        termsContract = new collateralized_simple_interest_terms_contract_1.CollateralizedSimpleInterestTermsContractContract(termsContractWeb3Contract, TX_DEFAULTS);
        ...
        yield mockCollateralToken.mockBalanceOfFor.sendTransactionAsync(DEBTOR, Units.ether(1));
        // Mock collateral token's allowance for proxy.
        yield mockCollateralToken.mockAllowanceFor.sendTransactionAsync(DEBTOR, mockTokenTransferProxy.address, Units.ether(1));
        // Grant the terms contract authorization to call the `collateralize` function.
        yield collateralizer.addAuthorizedCollateralizeAgent.sendTransactionAsync(termsContract.address);
    ...
    describe("#registerTermStart", () => __awaiter(this, void 0, void 0, function* () {
        ...
        describe("agent who is DebtKernel calls registerTermStart", () => {
            ...
            describe("agreement refers to different terms contract", () => {
                before(() => __awaiter(this, void 0, void 0, function* () {
                    yield mockDebtRegistry.mockGetTermsReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, NULL_ADDRESS, // NOT the terms contract's address
                    termsParams);
            ...
            describe("terms contract parameters are invalid", () => {
                describe("token at principalTokenIndex is undefined in registry", () => {
                    before(() => __awaiter(this, void 0, void 0, function* () {
                        yield mockDebtRegistry.mockGetTermsReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, termsContract.address, termsParams);
                ...
                describe("amortizationUnitType is not a valid value", () => {
                    before(() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield mockDebtRegistry.mockGetTermsReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, termsContract.address, invalidTermsParams);
                        yield mockTokenRegistry.mockGetTokenAddressByIndex.sendTransactionAsync(principalTokenIndex, mockToken.address);
                    }));
                    it("should revert the transaction", () => __awaiter(this, void 0, void 0, function* () {
                        yield expect(termsContract.registerTermStart.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, DEBTOR, {
            ...
            describe("Terms are valid for CollateralizedSimpleInterestTermsContractContract", () => {
                before(() => __awaiter(this, void 0, void 0, function* () {
                    yield mockDebtRegistry.mockGetTermsReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, termsContract.address, termsParamsWithCollateral);
                    yield mockTokenRegistry.mockGetTokenAddressByIndex.sendTransactionAsync(principalTokenIndex, mockToken.address);
                }));
                it("should emit log indicating success", () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    expect(logTermStart).to.deep.equal(simple_interest_terms_contract_1.LogSimpleInterestTermStart(termsContract.address, ARBITRARY_AGREEMENT_ID, mockToken.address, principalAmount, interestRateFixedPoint, amortizationUnitType, termLengthUnits));
                }));
            });
        });
    }));
    describe("#registerRepayment", () => {
        ...
        describe("RepaymentRouter calls registerRepayment", () => {
            before(() => __awaiter(this, void 0, void 0, function* () {
                ...
                yield mockDebtRegistry.mockGetBeneficiaryReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, BENEFICIARY);
                yield mockDebtRegistry.mockGetTermsReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, termsContract.address, termsContractParameters);
                yield mockDebtRegistry.mockGetTermsContractReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, termsContract.address);
            ...
            describe("...with terms contract's expected `tokenAddress`", () => {
                ...
                it("should generated an agreementToCollateralizer entry in Collateralizer", () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe("#getValueRepaidToDate", () => {
        describe("non-existent debt agreement", () => {
            ...
            before(() => __awaiter(this, void 0, void 0, function* () {
                yield mockDebtRegistry.mockGetBeneficiaryReturnValueFor.sendTransactionAsync(NON_EXISTENT_AGREEMENT_ID, NULL_ADDRESS);
        ...
        describe("extant debt agreement", () => {
            ...
            before(() => __awaiter(this, void 0, void 0, function* () {
                yield mockDebtRegistry.mockGetBeneficiaryReturnValueFor.sendTransactionAsync(EXTANT_AGREEMENT_ID, BENEFICIARY);
                yield mockDebtRegistry.mockGetTermsReturnValueFor.sendTransactionAsync(EXTANT_AGREEMENT_ID, termsContract.address, inputParamsAsHex);
                yield mockDebtRegistry.mockGetTermsContractReturnValueFor.sendTransactionAsync(EXTANT_AGREEMENT_ID, termsContract.address);
    ...
    describe("#getExpectedRepaymentValue", () => {
        describe("when termsContract associated w/ debt agreement is not `this`", () => {
            before(() => __awaiter(this, void 0, void 0, function* () {
                yield mockDebtRegistry.mockGetTermsContractReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, ATTACKER);
            }));
            it("should throw", () => __awaiter(this, void 0, void 0, function* () {
        ...
        describe("when termsContractParameters associated w/ debt agreement malformed", () => {
            ...
            describe("amortizationUnitType is not one of the valid types", () => {
                before(() => __awaiter(this, void 0, void 0, function* () {
                    yield mockDebtRegistry.mockGetTermsContractReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, termsContract.address);
                    yield mockDebtRegistry.mockGetTermsContractParameters.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, invalidTermsParams);
                    yield mockTokenRegistry.mockGetTokenAddressByIndex.sendTransactionAsync(principalTokenIndex, mockToken.address);
                }));
                it("should throw", () => __awaiter(this, void 0, void 0, function* () {
                    yield expect(termsContract.getExpectedRepaymentValue.callAsync(ARBITRARY_AGREEMENT_ID, new bignumber_js_1.BigNumber(moment().unix()))).to.eventually.be.rejectedWith(constants_1.REVERT_ERROR);
        ...
        describe("when termsContractParameters associated w/ debt agreement are well-formed", () => {
            ...
            */
            ...
            before(() => __awaiter(this, void 0, void 0, function* () {
                ...
                yield mockDebtRegistry.mockGetTermsContractReturnValueFor.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, termsContract.address);
                yield mockDebtRegistry.mockGetTermsContractParameters.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, validTermsParams);
                yield mockDebtRegistry.mockGetIssuanceBlockTimestamp.sendTransactionAsync(ARBITRARY_AGREEMENT_ID, new bignumber_js_1.BigNumber(BLOCK_ISSUANCE_TIMESTAMP));
                yield mockTokenRegistry.mockGetTokenAddressByIndex.sendTransactionAsync(principalTokenIndex, mockToken.address);
            }));
