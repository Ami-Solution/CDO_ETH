        ...
        this.transferFrom = {
            ...
            getABIEncodedTransactionData(_from, _to, _amount, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.transferFrom.getData, self.web3ContractInstance)(_from, _to, _amount, txDataWithDefaults);
        ...
        this.mockBalanceOfFor = {
            ...
            getABIEncodedTransactionData(_owner, _balance, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mockBalanceOfFor.getData, self.web3ContractInstance)(_owner, _balance, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.transfer = {
            ...
            getABIEncodedTransactionData(_to, _amount, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.transfer.getData, self.web3ContractInstance)(_to, _amount, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.mockAllowanceFor = {
            ...
            getABIEncodedTransactionData(_owner, _to, _allowance, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mockAllowanceFor.getData, self.web3ContractInstance)(_owner, _to, _allowance, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
