        ...
        this.removeOwner = {
            ...
            getABIEncodedTransactionData(owner, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.removeOwner.getData, self.web3ContractInstance)(owner, txDataWithDefaults);
        ...
        this.revokeConfirmation = {
            ...
            getABIEncodedTransactionData(transactionId, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.revokeConfirmation.getData, self.web3ContractInstance)(transactionId, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.executePauseTransactionImmediately = {
            ...
            estimateGasAsync(transactionId, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const gas = yield utils_1.promisify(self.web3ContractInstance.executePauseTransactionImmediately.estimateGas, self.web3ContractInstance)(transactionId, txDataWithDefaults);
                    return gas;
                });
            },
            getABIEncodedTransactionData(transactionId, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.executePauseTransactionImmediately.getData, self.web3ContractInstance)(transactionId, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.addOwner = {
            ...
            getABIEncodedTransactionData(owner, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.addOwner.getData, self.web3ContractInstance)(owner, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.changeTimeLock = {
            ...
            getABIEncodedTransactionData(_timelockInSeconds, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.changeTimeLock.getData, self.web3ContractInstance)(_timelockInSeconds, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.changeRequirement = {
            ...
            getABIEncodedTransactionData(_required, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.changeRequirement.getData, self.web3ContractInstance)(_required, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.confirmTransaction = {
            ...
            getABIEncodedTransactionData(transactionId, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.confirmTransaction.getData, self.web3ContractInstance)(transactionId, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.submitTransaction = {
            ...
            getABIEncodedTransactionData(destination, value, data, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.submitTransaction.getData, self.web3ContractInstance)(destination, value, data, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.replaceOwner = {
            ...
            getABIEncodedTransactionData(owner, newOwner, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.replaceOwner.getData, self.web3ContractInstance)(owner, newOwner, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.executeTransaction = {
            ...
            getABIEncodedTransactionData(transactionId, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.executeTransaction.getData, self.web3ContractInstance)(transactionId, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
