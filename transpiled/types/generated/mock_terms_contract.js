...
class MockTermsContractContract extends base_contract_1.BaseContract {
    constructor(web3ContractInstance, defaults) {
        ...
        this.mockRegisterTermStartReturnValue = {
            sendTransactionAsync(agreementId, debtor, success, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData, self.mockRegisterTermStartReturnValue.estimateGasAsync.bind(self, agreementId, debtor, success));
                    const txHash = yield utils_1.promisify(self.web3ContractInstance.mockRegisterTermStartReturnValue, self.web3ContractInstance)(agreementId, debtor, success, txDataWithDefaults);
                    return txHash;
                });
            },
            estimateGasAsync(agreementId, debtor, success, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const gas = yield utils_1.promisify(self.web3ContractInstance.mockRegisterTermStartReturnValue.estimateGas, self.web3ContractInstance)(agreementId, debtor, success, txDataWithDefaults);
                    return gas;
                });
            },
            getABIEncodedTransactionData(agreementId, debtor, success, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mockRegisterTermStartReturnValue.getData, self.web3ContractInstance)(agreementId, debtor, success, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
