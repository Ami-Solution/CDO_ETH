...
class DebtRegistryContract extends base_contract_1.BaseContract {
    constructor(web3ContractInstance, defaults) {
        ...
        this.EDIT_CONTEXT = {
            callAsync(defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.EDIT_CONTEXT.call, self.web3ContractInstance)();
                    return result;
                });
            },
        };
        ...
        this.addAuthorizedEditAgent = {
            ...
            getABIEncodedTransactionData(agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.addAuthorizedEditAgent.getData, self.web3ContractInstance)(agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.modifyBeneficiary = {
            ...
            getABIEncodedTransactionData(issuanceHash, newBeneficiary, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.modifyBeneficiary.getData, self.web3ContractInstance)(issuanceHash, newBeneficiary, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.getDebtorsDebts = {
            callAsync(debtor, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.getDebtorsDebts.call, self.web3ContractInstance)(debtor);
                    return result;
                });
            },
        };
        ...
        this.INSERT_CONTEXT = {
            callAsync(defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.INSERT_CONTEXT.call, self.web3ContractInstance)();
                    return result;
                });
            },
        };
        ...
        this.revokeEditAgentAuthorization = {
            ...
            getABIEncodedTransactionData(agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.revokeEditAgentAuthorization.getData, self.web3ContractInstance)(agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.addAuthorizedInsertAgent = {
            ...
            getABIEncodedTransactionData(agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.addAuthorizedInsertAgent.getData, self.web3ContractInstance)(agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.revokeInsertAgentAuthorization = {
            ...
            getABIEncodedTransactionData(agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.revokeInsertAgentAuthorization.getData, self.web3ContractInstance)(agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.insert = {
            ...
            getABIEncodedTransactionData(_version, _beneficiary, _debtor, _underwriter, _underwriterRiskRating, _termsContract, _termsContractParameters, _salt, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.insert.getData, self.web3ContractInstance)(_version, _beneficiary, _debtor, _underwriter, _underwriterRiskRating, _termsContract, _termsContractParameters, _salt, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
