    ...
    constructor(web3ContractInstance, defaults) {
        ...
        this.cancelDebtOrder = {
            ...
            getABIEncodedTransactionData(orderAddresses, orderValues, orderBytes32, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.cancelDebtOrder.getData, self.web3ContractInstance)(orderAddresses, orderValues, orderBytes32, txDataWithDefaults);
        ...
        this.debtOrderCancelled = {
            callAsync(index_0, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.debtOrderCancelled.call, self.web3ContractInstance)(index_0);
                    return result;
                });
            },
        };
        ...
        this.issuanceCancelled = {
            callAsync(index_0, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.issuanceCancelled.call, self.web3ContractInstance)(index_0);
                    return result;
                });
            },
        };
        ...
        this.setDebtToken = {
            ...
            getABIEncodedTransactionData(debtTokenAddress, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.setDebtToken.getData, self.web3ContractInstance)(debtTokenAddress, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.cancelIssuance = {
            ...
            getABIEncodedTransactionData(version, debtor, termsContract, termsContractParameters, underwriter, underwriterRiskRating, salt, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.cancelIssuance.getData, self.web3ContractInstance)(version, debtor, termsContract, termsContractParameters, underwriter, underwriterRiskRating, salt, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.fillDebtOrder = {
            ...
            getABIEncodedTransactionData(creditor, orderAddresses, orderValues, orderBytes32, signaturesV, signaturesR, signaturesS, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.fillDebtOrder.getData, self.web3ContractInstance)(creditor, orderAddresses, orderValues, orderBytes32, signaturesV, signaturesR, signaturesS, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
