        ...
        this.revokeTokenURIAuthorization = {
            ...
            getABIEncodedTransactionData(_agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.revokeTokenURIAuthorization.getData, self.web3ContractInstance)(_agent, txDataWithDefaults);
        ...
        this.approve = {
            ...
            getABIEncodedTransactionData(_to, _tokenId, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.approve.getData, self.web3ContractInstance)(_to, _tokenId, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.setTokenURI = {
            ...
            getABIEncodedTransactionData(_tokenId, _uri, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.setTokenURI.getData, self.web3ContractInstance)(_tokenId, _uri, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.transferFrom = {
            ...
            getABIEncodedTransactionData(_from, _to, _tokenId, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.transferFrom.getData, self.web3ContractInstance)(_from, _to, _tokenId, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.addAuthorizedTokenURIAgent = {
            ...
            getABIEncodedTransactionData(_agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.addAuthorizedTokenURIAgent.getData, self.web3ContractInstance)(_agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.unpause = {
            ...
            getABIEncodedTransactionData(txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.unpause.getData, self.web3ContractInstance)(txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.safeTransferFrom = {
            ...
            getABIEncodedTransactionData(_from, _to, _tokenId, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.safeTransferFrom.getData, self.web3ContractInstance)(_from, _to, _tokenId, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.revokeMintAgentAuthorization = {
            ...
            getABIEncodedTransactionData(_agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.revokeMintAgentAuthorization.getData, self.web3ContractInstance)(_agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.setApprovalForAll = {
            ...
            getABIEncodedTransactionData(_to, _approved, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.setApprovalForAll.getData, self.web3ContractInstance)(_to, _approved, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.safeTransferFrom = {
            ...
            getABIEncodedTransactionData(_from, _to, _tokenId, _data, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.safeTransferFrom.getData, self.web3ContractInstance)(_from, _to, _tokenId, _data, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
