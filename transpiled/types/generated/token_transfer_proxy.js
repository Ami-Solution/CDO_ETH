    ...
    constructor(web3ContractInstance, defaults) {
        ...
        this.addAuthorizedTransferAgent = {
            ...
            getABIEncodedTransactionData(_agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.addAuthorizedTransferAgent.getData, self.web3ContractInstance)(_agent, txDataWithDefaults);
        ...
        this.transferFrom = {
            ...
            getABIEncodedTransactionData(_token, _from, _to, _amount, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.transferFrom.getData, self.web3ContractInstance)(_token, _from, _to, _amount, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.CONTEXT = {
            callAsync(defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.CONTEXT.call, self.web3ContractInstance)();
                    return result;
                });
            },
        };
        ...
        this.revokeTransferAgentAuthorization = {
            ...
            getABIEncodedTransactionData(_agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.revokeTransferAgentAuthorization.getData, self.web3ContractInstance)(_agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
