    ...
    constructor(web3ContractInstance, defaults) {
        ...
        this.SECOND_SET = {
            callAsync(defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.SECOND_SET.call, self.web3ContractInstance)();
                    return result;
                });
            },
        };
        this.revokeInFirstSet = {
            ...
            getABIEncodedTransactionData(agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.revokeInFirstSet.getData, self.web3ContractInstance)(agent, txDataWithDefaults);
        ...
        this.revokeInSecondSet = {
            ...
            getABIEncodedTransactionData(agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.revokeInSecondSet.getData, self.web3ContractInstance)(agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.authorizeInSecondSet = {
            ...
            getABIEncodedTransactionData(agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.authorizeInSecondSet.getData, self.web3ContractInstance)(agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.authorizeInFirstSet = {
            ...
            getABIEncodedTransactionData(agent, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.authorizeInFirstSet.getData, self.web3ContractInstance)(agent, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.FIRST_SET = {
            callAsync(defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const result = yield utils_1.promisify(self.web3ContractInstance.FIRST_SET.call, self.web3ContractInstance)();
                    return result;
                });
            },
        };
