        ...
        this.setTokenAttributes = {
            ...
            getABIEncodedTransactionData(_symbol, _tokenAddress, _tokenName, _numDecimals, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.setTokenAttributes.getData, self.web3ContractInstance)(_symbol, _tokenAddress, _tokenName, _numDecimals, txDataWithDefaults);
