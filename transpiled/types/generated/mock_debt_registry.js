        ...
        this.mockGetTermsContractReturnValueFor = {
            ...
            getABIEncodedTransactionData(issuanceHash, termsContract, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mockGetTermsContractReturnValueFor.getData, self.web3ContractInstance)(issuanceHash, termsContract, txDataWithDefaults);
        ...
        this.mockInsertReturnValue = {
            ...
            getABIEncodedTransactionData(issuanceHash, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mockInsertReturnValue.getData, self.web3ContractInstance)(issuanceHash, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.mockGetTermsReturnValueFor = {
            ...
            getABIEncodedTransactionData(issuanceHash, termsContract, termsContractParameters, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mockGetTermsReturnValueFor.getData, self.web3ContractInstance)(issuanceHash, termsContract, termsContractParameters, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.mockGetBeneficiaryReturnValueFor = {
            ...
            getABIEncodedTransactionData(issuanceHash, beneficiary, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mockGetBeneficiaryReturnValueFor.getData, self.web3ContractInstance)(issuanceHash, beneficiary, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
