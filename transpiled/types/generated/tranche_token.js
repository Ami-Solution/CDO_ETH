...
class TrancheTokenContract extends base_contract_1.BaseContract {
    constructor(web3ContractInstance, defaults) {
        ...
        this.mintCDOTrancheToken = {
            sendTransactionAsync(cdo, _creator, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData, self.mintCDOTrancheToken.estimateGasAsync.bind(self, cdo, _creator));
                    const txHash = yield utils_1.promisify(self.web3ContractInstance.mintCDOTrancheToken, self.web3ContractInstance)(cdo, _creator, txDataWithDefaults);
                    return txHash;
                });
            },
            estimateGasAsync(cdo, _creator, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const gas = yield utils_1.promisify(self.web3ContractInstance.mintCDOTrancheToken.estimateGas, self.web3ContractInstance)(cdo, _creator, txDataWithDefaults);
                    return gas;
                });
            },
            getABIEncodedTransactionData(cdo, _creator, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mintCDOTrancheToken.getData, self.web3ContractInstance)(cdo, _creator, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
