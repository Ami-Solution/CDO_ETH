        ...
        this.updateAddress = {
            ...
            getABIEncodedTransactionData(contractType, newAddress, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.updateAddress.getData, self.web3ContractInstance)(contractType, newAddress, txDataWithDefaults);
