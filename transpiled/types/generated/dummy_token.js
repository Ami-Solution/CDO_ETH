        ...
        this.approve = {
            ...
            getABIEncodedTransactionData(_spender, _value, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.approve.getData, self.web3ContractInstance)(_spender, _value, txDataWithDefaults);
        ...
        this.transferFrom = {
            ...
            getABIEncodedTransactionData(_from, _to, _value, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.transferFrom.getData, self.web3ContractInstance)(_from, _to, _value, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.mint = {
            ...
            getABIEncodedTransactionData(_to, _amount, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mint.getData, self.web3ContractInstance)(_to, _amount, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.decreaseApproval = {
            ...
            getABIEncodedTransactionData(_spender, _subtractedValue, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.decreaseApproval.getData, self.web3ContractInstance)(_spender, _subtractedValue, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.finishMinting = {
            ...
            getABIEncodedTransactionData(txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.finishMinting.getData, self.web3ContractInstance)(txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.transfer = {
            ...
            getABIEncodedTransactionData(_to, _value, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.transfer.getData, self.web3ContractInstance)(_to, _value, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        this.increaseApproval = {
            ...
            getABIEncodedTransactionData(_spender, _addedValue, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.increaseApproval.getData, self.web3ContractInstance)(_spender, _addedValue, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
        ...
        this.setBalance = {
            ...
            getABIEncodedTransactionData(_target, _value, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.setBalance.getData, self.web3ContractInstance)(_target, _value, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
