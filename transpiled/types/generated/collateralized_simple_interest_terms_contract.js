...
class CollateralizedSimpleInterestTermsContractContract extends base_contract_1.BaseContract {
    ...
    static getArtifactsData(web3) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const artifact = yield fs.readFile("build/contracts/CollateralizedSimpleInterestTermsContract.json", "utf8");
