        ...
        this.mockGetApprovedFor = {
            ...
            getABIEncodedTransactionData(_tokenId, _approved, txData = {}) {
                return __awaiter(this, void 0, void 0, function* () {
                    const self = this;
                    const txDataWithDefaults = yield self.applyDefaultsToTxDataAsync(txData);
                    const abiEncodedTransactionData = yield utils_1.promisify(self.web3ContractInstance.mockGetApprovedFor.getData, self.web3ContractInstance)(_tokenId, _approved, txDataWithDefaults);
                    return abiEncodedTransactionData;
                });
            },
        };
