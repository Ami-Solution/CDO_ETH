...
export class DebtTokenContract extends BaseContract {
    public revokeTokenURIAuthorization = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.revokeTokenURIAuthorization.estimateGasAsync.bind(
                    self,
                    _agent,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.revokeTokenURIAuthorization, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.revokeTokenURIAuthorization.estimateGas, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.revokeTokenURIAuthorization.getData, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
    ...
    public setTokenURI = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.setTokenURI.estimateGasAsync.bind(
                    self,
                    _tokenId,
                    _uri,
                ),
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.setTokenURI, self.web3ContractInstance,
            )(
                _tokenId,
                _uri,
                txDataWithDefaults,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.setTokenURI.estimateGas, self.web3ContractInstance,
            )(
                _tokenId,
                _uri,
                txDataWithDefaults,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.setTokenURI.getData, self.web3ContractInstance,
            )(
                _tokenId,
                _uri,
                txDataWithDefaults,
    ...
    public addAuthorizedTokenURIAgent = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.addAuthorizedTokenURIAgent.estimateGasAsync.bind(
                    self,
                    _agent,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.addAuthorizedTokenURIAgent, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.addAuthorizedTokenURIAgent.estimateGas, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.addAuthorizedTokenURIAgent.getData, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
    ...
    public safeTransferFrom = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.safeTransferFrom, self.web3ContractInstance,
            )(
                _from,
                _to,
                _tokenId,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.safeTransferFrom.estimateGas, self.web3ContractInstance,
            )(
                _from,
                _to,
                _tokenId,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.safeTransferFrom.getData, self.web3ContractInstance,
            )(
                _from,
                _to,
                _tokenId,
    ...
    public revokeMintAgentAuthorization = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.revokeMintAgentAuthorization.estimateGasAsync.bind(
                    self,
                    _agent,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.revokeMintAgentAuthorization, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.revokeMintAgentAuthorization.estimateGas, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.revokeMintAgentAuthorization.getData, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
    ...
    public create = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.create.getData, self.web3ContractInstance,
            )(
                _version,
                _beneficiary,
                _debtor,
    ...
    public addAuthorizedMintAgent = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.addAuthorizedMintAgent.getData, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
    ...
    public setApprovalForAll = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.setApprovalForAll, self.web3ContractInstance,
            )(
                _to,
                _approved,
                txDataWithDefaults,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.setApprovalForAll.estimateGas, self.web3ContractInstance,
            )(
                _to,
                _approved,
                txDataWithDefaults,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.setApprovalForAll.getData, self.web3ContractInstance,
            )(
                _to,
                _approved,
                txDataWithDefaults,
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<DebtTokenContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<DebtTokenContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/DebtToken.json", "utf8");
