...
export class NFTTermsContractContract extends BaseContract {
    public registerNFTRepayment = {
        async sendTransactionAsync(
            ...
            const self = this as NFTTermsContractContract;
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.registerNFTRepayment.getData, self.web3ContractInstance,
            )(
                agreementId,
                payer,
                beneficiary,
    ...
    >(
                self.web3ContractInstance.SEVEN_DAYS_IN_BLOCKS.call,
    ...
    > {
            ...
            const result = await promisify<string
    >(
                self.web3ContractInstance.repaymentPrincipalNFT.call,
                self.web3ContractInstance,
            )(
            );
            return result;
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<NFTTermsContractContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<NFTTermsContractContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/NFTTermsContract.json", "utf8");
