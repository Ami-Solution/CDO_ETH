...
export class OwnableContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<OwnableContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<OwnableContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/Ownable.json", "utf8");
