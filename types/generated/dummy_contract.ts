...
export class DummyContractContract extends BaseContract {
    ...
    public revokeInFirstSet = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.revokeInFirstSet.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    public revokeInSecondSet = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.revokeInSecondSet.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    public authorizeInSecondSet = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.authorizeInSecondSet.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    public authorizeInFirstSet = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.authorizeInFirstSet.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<DummyContractContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<DummyContractContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/DummyContract.json", "utf8");
