...
export class MockDebtRegistryContract extends BaseContract {
    ...
    public mockGetTermsContractReturnValueFor = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.mockGetTermsContractReturnValueFor, self.web3ContractInstance,
            )(
                issuanceHash,
                termsContract,
                txDataWithDefaults,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mockGetTermsContractReturnValueFor.estimateGas, self.web3ContractInstance,
            )(
                issuanceHash,
                termsContract,
                txDataWithDefaults,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mockGetTermsContractReturnValueFor.getData, self.web3ContractInstance,
            )(
                issuanceHash,
                termsContract,
                txDataWithDefaults,
    ...
    public modifyBeneficiary = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.modifyBeneficiary, self.web3ContractInstance,
            )(
                issuanceHash,
                newBeneficiary,
                txDataWithDefaults,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.modifyBeneficiary.estimateGas, self.web3ContractInstance,
            )(
                issuanceHash,
                newBeneficiary,
                txDataWithDefaults,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.modifyBeneficiary.getData, self.web3ContractInstance,
            )(
                issuanceHash,
                newBeneficiary,
                txDataWithDefaults,
    ...
    public mockInsertReturnValue = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.mockInsertReturnValue.estimateGasAsync.bind(
                    self,
                    issuanceHash,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.mockInsertReturnValue, self.web3ContractInstance,
            )(
                issuanceHash,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mockInsertReturnValue.estimateGas, self.web3ContractInstance,
            )(
                issuanceHash,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mockInsertReturnValue.getData, self.web3ContractInstance,
            )(
                issuanceHash,
                txDataWithDefaults,
            );
    ...
    public mockGetTermsReturnValueFor = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.mockGetTermsReturnValueFor, self.web3ContractInstance,
            )(
                issuanceHash,
                termsContract,
                termsContractParameters,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mockGetTermsReturnValueFor.estimateGas, self.web3ContractInstance,
            )(
                issuanceHash,
                termsContract,
                termsContractParameters,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mockGetTermsReturnValueFor.getData, self.web3ContractInstance,
            )(
                issuanceHash,
                termsContract,
                termsContractParameters,
    ...
    public insert = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.insert.getData, self.web3ContractInstance,
            )(
                _version,
                _beneficiary,
                _debtor,
    ...
    public mockGetBeneficiaryReturnValueFor = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.mockGetBeneficiaryReturnValueFor, self.web3ContractInstance,
            )(
                issuanceHash,
                beneficiary,
                txDataWithDefaults,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mockGetBeneficiaryReturnValueFor.estimateGas, self.web3ContractInstance,
            )(
                issuanceHash,
                beneficiary,
                txDataWithDefaults,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mockGetBeneficiaryReturnValueFor.getData, self.web3ContractInstance,
            )(
                issuanceHash,
                beneficiary,
                txDataWithDefaults,
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<MockDebtRegistryContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<MockDebtRegistryContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/MockDebtRegistry.json", "utf8");
