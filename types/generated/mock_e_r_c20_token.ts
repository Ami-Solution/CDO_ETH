...
export class MockERC20TokenContract extends BaseContract {
    ...
    public mockAllowanceFor = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.mockAllowanceFor, self.web3ContractInstance,
            )(
                _owner,
                _to,
                _allowance,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mockAllowanceFor.estimateGas, self.web3ContractInstance,
            )(
                _owner,
                _to,
                _allowance,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mockAllowanceFor.getData, self.web3ContractInstance,
            )(
                _owner,
                _to,
                _allowance,
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<MockERC20TokenContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<MockERC20TokenContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/MockERC20Token.json", "utf8");
