...
export class MockZeroExExchangeContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<MockZeroExExchangeContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<MockZeroExExchangeContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/MockZeroExExchange.json", "utf8");
