...
export class ERC20BasicContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<ERC20BasicContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<ERC20BasicContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/ERC20Basic.json", "utf8");
