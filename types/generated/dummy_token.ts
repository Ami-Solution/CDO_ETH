...
export class DummyTokenContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<DummyTokenContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<DummyTokenContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/DummyToken.json", "utf8");
