...
export class MockERC721ReceiverContract extends BaseContract {
    ...
    public setReturnValueForERC721ReceivedHook = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.setReturnValueForERC721ReceivedHook, self.web3ContractInstance,
            )(
                _returnValue,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.setReturnValueForERC721ReceivedHook.estimateGas, self.web3ContractInstance,
            )(
                _returnValue,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.setReturnValueForERC721ReceivedHook.getData, self.web3ContractInstance,
            )(
                _returnValue,
                txDataWithDefaults,
            );
    ...
    public setShouldRevert = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.setShouldRevert.estimateGasAsync.bind(
                    self,
                    _shouldRevert,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.setShouldRevert, self.web3ContractInstance,
            )(
                _shouldRevert,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.setShouldRevert.estimateGas, self.web3ContractInstance,
            )(
                _shouldRevert,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.setShouldRevert.getData, self.web3ContractInstance,
            )(
                _shouldRevert,
                txDataWithDefaults,
            );
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<MockERC721ReceiverContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<MockERC721ReceiverContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/MockERC721Receiver.json", "utf8");
