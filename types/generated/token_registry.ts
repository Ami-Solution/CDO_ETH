...
export class TokenRegistryContract extends BaseContract {
    ...
    > {
            ...
            const result = await promisify<[string, string, string, BigNumber]
    >(
    ...
    > {
            const self = this as TokenRegistryContract;
            const result = await promisify<[string, BigNumber, string, BigNumber]
    >(
    ...
    > {
            ...
            const result = await promisify<BigNumber
    >(
                self.web3ContractInstance.getNumDecimalsByIndex.call,
                self.web3ContractInstance,
            )(
                _index,
            );
    ...
    public setTokenAttributes = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.setTokenAttributes, self.web3ContractInstance,
            )(
                _symbol,
                _tokenAddress,
                _tokenName,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.setTokenAttributes.estimateGas, self.web3ContractInstance,
            )(
                _symbol,
                _tokenAddress,
                _tokenName,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.setTokenAttributes.getData, self.web3ContractInstance,
            )(
                _symbol,
                _tokenAddress,
                _tokenName,
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<TokenRegistryContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<TokenRegistryContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/TokenRegistry.json", "utf8");
