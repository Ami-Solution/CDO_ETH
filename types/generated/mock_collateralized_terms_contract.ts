...
export class MockCollateralizedTermsContractContract extends BaseContract {
    ...
    public mockDummyValueRepaid = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.mockDummyValueRepaid, self.web3ContractInstance,
            )(
                agreementId,
                amount,
                txDataWithDefaults,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mockDummyValueRepaid.estimateGas, self.web3ContractInstance,
            )(
                agreementId,
                amount,
                txDataWithDefaults,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mockDummyValueRepaid.getData, self.web3ContractInstance,
            )(
                agreementId,
                amount,
                txDataWithDefaults,
    ...
    public mockCallCollateralize = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.mockCallCollateralize, self.web3ContractInstance,
            )(
                _collateralizer,
                _agreementId,
                _debtor,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mockCallCollateralize.estimateGas, self.web3ContractInstance,
            )(
                _collateralizer,
                _agreementId,
                _debtor,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mockCallCollateralize.getData, self.web3ContractInstance,
            )(
                _collateralizer,
                _agreementId,
                _debtor,
    ...
    public mockExpectedRepaymentValue = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.mockExpectedRepaymentValue, self.web3ContractInstance,
            )(
                agreementId,
                timestamp,
                amount,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mockExpectedRepaymentValue.estimateGas, self.web3ContractInstance,
            )(
                agreementId,
                timestamp,
                amount,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mockExpectedRepaymentValue.getData, self.web3ContractInstance,
            )(
                agreementId,
                timestamp,
                amount,
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<MockCollateralizedTermsContractContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<MockCollateralizedTermsContractContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/MockCollateralizedTermsContract.json", "utf8");
