...
export class CollateralizerContract extends BaseContract {
    ...
    public returnCollateral = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.returnCollateral.estimateGasAsync.bind(
                    self,
                    agreementId,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.returnCollateral, self.web3ContractInstance,
            )(
                agreementId,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.returnCollateral.estimateGas, self.web3ContractInstance,
            )(
                agreementId,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.returnCollateral.getData, self.web3ContractInstance,
            )(
                agreementId,
                txDataWithDefaults,
            );
    ...
    public collateralize = {
        async sendTransactionAsync(
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.collateralize, self.web3ContractInstance,
            )(
                agreementId,
                collateralizer,
                txDataWithDefaults,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.collateralize.estimateGas, self.web3ContractInstance,
            )(
                agreementId,
                collateralizer,
                txDataWithDefaults,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.collateralize.getData, self.web3ContractInstance,
            )(
                agreementId,
                collateralizer,
                txDataWithDefaults,
    ...
    public revokeCollateralizeAuthorization = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.revokeCollateralizeAuthorization.estimateGasAsync.bind(
                    self,
                    agent,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.revokeCollateralizeAuthorization, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.revokeCollateralizeAuthorization.estimateGas, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.revokeCollateralizeAuthorization.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    public addAuthorizedCollateralizeAgent = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.addAuthorizedCollateralizeAgent.estimateGasAsync.bind(
                    self,
                    agent,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.addAuthorizedCollateralizeAgent, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.addAuthorizedCollateralizeAgent.estimateGas, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.addAuthorizedCollateralizeAgent.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    public seizeCollateral = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.seizeCollateral.estimateGasAsync.bind(
                    self,
                    agreementId,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.seizeCollateral, self.web3ContractInstance,
            )(
                agreementId,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.seizeCollateral.estimateGas, self.web3ContractInstance,
            )(
                agreementId,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.seizeCollateral.getData, self.web3ContractInstance,
            )(
                agreementId,
                txDataWithDefaults,
            );
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<CollateralizerContract> {
