...
export class IncompatibleTermsContractContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<IncompatibleTermsContractContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<IncompatibleTermsContractContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/IncompatibleTermsContract.json", "utf8");
