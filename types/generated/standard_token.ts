...
export class StandardTokenContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<StandardTokenContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<StandardTokenContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/StandardToken.json", "utf8");
