...
export class ERC721ReceiverContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<ERC721ReceiverContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<ERC721ReceiverContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/ERC721Receiver.json", "utf8");
