...
export class ERC721TokenContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<ERC721TokenContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<ERC721TokenContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/ERC721Token.json", "utf8");
