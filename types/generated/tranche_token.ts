...
export class TrancheTokenContract extends BaseContract {
    public name = {
        async callAsync(
            defaultBlock?: Web3.BlockParam,
        ): Promise<string
    > {
            const self = this as TrancheTokenContract;
    ...
    public mintCDOTrancheToken = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.mintCDOTrancheToken.estimateGasAsync.bind(
                    self,
                    cdo,
                    _creator,
                ),
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.mintCDOTrancheToken, self.web3ContractInstance,
            )(
                cdo,
                _creator,
                txDataWithDefaults,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mintCDOTrancheToken.estimateGas, self.web3ContractInstance,
            )(
                cdo,
                _creator,
                txDataWithDefaults,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mintCDOTrancheToken.getData, self.web3ContractInstance,
            )(
                cdo,
                _creator,
                txDataWithDefaults,
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<TrancheTokenContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<TrancheTokenContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/TrancheToken.json", "utf8");
