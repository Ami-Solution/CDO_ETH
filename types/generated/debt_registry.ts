...
export class DebtRegistryContract extends BaseContract {
    ...
    public addAuthorizedEditAgent = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.addAuthorizedEditAgent.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    > {
            const self = this as DebtRegistryContract;
            const result = await promisify<[string, string, string, BigNumber, string, string, BigNumber]
    >(
    ...
    public revokeEditAgentAuthorization = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.revokeEditAgentAuthorization.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    public addAuthorizedInsertAgent = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.addAuthorizedInsertAgent.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    public revokeInsertAgentAuthorization = {
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.revokeInsertAgentAuthorization.getData, self.web3ContractInstance,
            )(
                agent,
                txDataWithDefaults,
            );
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<DebtRegistryContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<DebtRegistryContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/DebtRegistry.json", "utf8");
