...
export class MockDebtTokenContract extends BaseContract {
    ...
    public mockCreateReturnValue = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.mockCreateReturnValue.estimateGasAsync.bind(
                    self,
                    _tokenId,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.mockCreateReturnValue, self.web3ContractInstance,
            )(
                _tokenId,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.mockCreateReturnValue.estimateGas, self.web3ContractInstance,
            )(
                _tokenId,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.mockCreateReturnValue.getData, self.web3ContractInstance,
            )(
                _tokenId,
                txDataWithDefaults,
            );
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<MockDebtTokenContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<MockDebtTokenContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/MockDebtToken.json", "utf8");
