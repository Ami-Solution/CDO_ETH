...
export class TokenTransferProxyContract extends BaseContract {
    public addAuthorizedTransferAgent = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.addAuthorizedTransferAgent.estimateGasAsync.bind(
                    self,
                    _agent,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.addAuthorizedTransferAgent, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.addAuthorizedTransferAgent.estimateGas, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.addAuthorizedTransferAgent.getData, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
    ...
    public revokeTransferAgentAuthorization = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.revokeTransferAgentAuthorization.estimateGasAsync.bind(
                    self,
                    _agent,
                ),
            );
            const txHash = await promisify<string>(
                self.web3ContractInstance.revokeTransferAgentAuthorization, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.revokeTransferAgentAuthorization.estimateGas, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.revokeTransferAgentAuthorization.getData, self.web3ContractInstance,
            )(
                _agent,
                txDataWithDefaults,
            );
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<TokenTransferProxyContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<TokenTransferProxyContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/TokenTransferProxy.json", "utf8");
