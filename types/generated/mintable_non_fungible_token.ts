...
export class MintableNonFungibleTokenContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<MintableNonFungibleTokenContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<MintableNonFungibleTokenContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/MintableNonFungibleToken.json", "utf8");
