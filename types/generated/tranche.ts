...
export class TrancheContract extends BaseContract {
    public name = {
        async callAsync(
            defaultBlock?: Web3.BlockParam,
        ): Promise<string
    > {
            const self = this as TrancheContract;
    ...
    > {
            ...
            const result = await promisify<BigNumber
    >(
                self.web3ContractInstance.totalPayout.call,
                self.web3ContractInstance,
            )(
            );
            return result;
    ...
    > {
            ...
            const result = await promisify<BigNumber
    >(
                self.web3ContractInstance.currentPayout.call,
                self.web3ContractInstance,
            )(
                _tokenId,
            );
    ...
    > {
            ...
            const result = await promisify<BigNumber
    >(
                self.web3ContractInstance.trancheLimit.call,
                self.web3ContractInstance,
            )(
            );
            return result;
    ...
    > {
            ...
            const result = await promisify<BigNumber
    >(
                self.web3ContractInstance.expectedPayoutTotal.call,
                self.web3ContractInstance,
            )(
            );
            return result;
    ...
    > {
            ...
            const result = await promisify<BigNumber
    >(
                self.web3ContractInstance.tokenPayouts.call,
                self.web3ContractInstance,
            )(
                index_0,
            );
    ...
    > {
            ...
            const result = await promisify<BigNumber
    >(
                self.web3ContractInstance.trancheValue.call,
                self.web3ContractInstance,
            )(
            );
            return result;
    ...
    public matchPayout = {
        async sendTransactionAsync(
            _tokenId: BigNumber,
            _totalToMatch: BigNumber,
            txData: TxData = {},
        ): Promise<string> {
            const self = this as TrancheContract;
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
                self.matchPayout.estimateGasAsync.bind(
                    self,
                    _tokenId,
                    _totalToMatch,
                ),
            ...
            const txHash = await promisify<string>(
                self.web3ContractInstance.matchPayout, self.web3ContractInstance,
            )(
                _tokenId,
                _totalToMatch,
                txDataWithDefaults,
        ...
        async estimateGasAsync(
            ...
            const gas = await promisify<number>(
                self.web3ContractInstance.matchPayout.estimateGas, self.web3ContractInstance,
            )(
                _tokenId,
                _totalToMatch,
                txDataWithDefaults,
        ...
        async getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = await promisify<string>(
                self.web3ContractInstance.matchPayout.getData, self.web3ContractInstance,
            )(
                _tokenId,
                _totalToMatch,
                txDataWithDefaults,
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<TrancheContract> {
        const currentNetwork = web3.version.network;
        const { abi, networks } = await this.getArtifactsData(web3);
        const web3ContractInstance = web3.eth.contract(abi).at(networks[currentNetwork].address);

        return new TrancheContract(web3ContractInstance, defaults);
    }
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<TrancheContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/Tranche.json", "utf8");
