...
export class ERC721MetadataContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<ERC721MetadataContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<ERC721MetadataContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/ERC721Metadata.json", "utf8");
