...
export class PausableContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<PausableContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<PausableContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/Pausable.json", "utf8");
