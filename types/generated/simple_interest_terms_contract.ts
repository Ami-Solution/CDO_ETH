...
export class SimpleInterestTermsContractContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<SimpleInterestTermsContractContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<SimpleInterestTermsContractContract> {
    ...
    {
        try {
            const artifact = await fs.readFile("build/contracts/SimpleInterestTermsContract.json", "utf8");
